...
<head>
    ...
    <title> SMP_Assalaam_Dashboard </title>
                        ...
                        <div class="col-md-7 col-lg-4 col-xlg-4">
                            <div class="card card-hover">
                                <div class="box bg-cyan text-center">
                                    <a href="#" class="btn btn-info btn-lag">
                        ...
                        <div class="col-md-7 col-lg-4 col-xlg-4">
                            <div class="card card-hover">
                                <div class="box bg-danger text-center">
                                    <a href="#" class="btn btn-danger btn-lag text-white">
                        ...
                        <div class="col-md-7 col-lg-4 col-xlg-4">
                            <div class="card card-hover">
                                <div class="box bg-warning text-center">
                                    <a href="#" class="btn btn-warning btn-lag text-white">
                                        <h1><i class="fa fa-clipboard"></i></h1>
                                        <h6><span> Ubah Status Absen </span></h6>
                                    </a>
