...
?>
   ...
   <div class="py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center mt-4">Rekap Hari</h1>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered " id="myTable">
              ...
              <!-- <tbody> -->
                ...
                ?>
                <tr>
                  <th class="align-items-center justify-content-center text-center"><?php echo $d['tanggal'] ?></th>
                  ...
                  <td class="justify-content-center align-items-center text-center"><?php echo $sumlanggar ?></td>
