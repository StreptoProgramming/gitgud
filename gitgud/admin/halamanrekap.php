            ...
            <table class="table table-bordered " id="myTable">
              <thead class="thead-primary">
                <tr class="bg-success">
                  ...
                  <th class="table-primary align-items-center justify-content-center text-center bg-success">Kehadiran Tepat Waktu</th>
                </tr>
              </thead>
              <!-- <tbody> -->
                <?php 
                ...
                <tr>
                  ...
                  <td class="justify-content-center align-items-center text-center"><?php echo $persen."%" ?></td>
                </tr>
             <!--  </tbody> -->
              <?php } ?>
            </table>
